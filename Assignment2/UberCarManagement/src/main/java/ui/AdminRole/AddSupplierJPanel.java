...
public class AddSupplierJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Add New Supplier Information");
...
//        check whether any of the attribute is empty or not
...
//        Check supplier uniqueness
        for (Supplier supplier : supplierDirectory.getSupplierlist()) {
            if (supplier.getSupplyName().equalsIgnoreCase(txtName.getText())) {
